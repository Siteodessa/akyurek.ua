...
function killShapes() {
  jQuery('#box .c1').removeClass('vigna-separ-clip1 vigna-polir-clip1 vigna-trans-clip1 vigna-defence-clip1 vigna-hranenie-clip1'); 
jQuery('#box .c2').removeClass('vigna-separ-clip2 vigna-polir-clip2 vigna-trans-clip2 vigna-defence-clip2 vigna-hranenie-clip2'); 
jQuery('#box .c3').removeClass('vigna-separ-clip3 vigna-polir-clip3 vigna-trans-clip3 vigna-defence-clip3 vigna-hranenie-clip3'); 
jQuery('#box .c4').removeClass('vigna-separ-clip4 vigna-polir-clip4 vigna-trans-clip4 vigna-defence-clip4 vigna-hranenie-clip4'); 
jQuery('#box .c5').removeClass('vigna-separ-clip5 vigna-polir-clip5 vigna-trans-clip5 vigna-defence-clip5 vigna-hranenie-clip5');
}
function animOut() {    
...
jQuery('#box .c5').removeClass(''+z+'-clip5'); }, 1400)
    ...
    {
jQuery('#box').removeClass('vigna-separ').removeClass('vigna-polir').removeClass('vigna-trans').removeClass('vigna-defence').removeClass('vigna-hranenie').addClass(z);
animOut();
