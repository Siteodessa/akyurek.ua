...
function killShapes() {
  jQuery('#box .c1').removeClass('pigeon-separ-clip1 pigeon-polir-clip1 pigeon-trans-clip1 pigeon-defence-clip1 pigeon-hranenie-clip1'); 
jQuery('#box .c2').removeClass('pigeon-separ-clip2 pigeon-polir-clip2 pigeon-trans-clip2 pigeon-defence-clip2 pigeon-hranenie-clip2'); 
jQuery('#box .c3').removeClass('pigeon-separ-clip3 pigeon-polir-clip3 pigeon-trans-clip3 pigeon-defence-clip3 pigeon-hranenie-clip3'); 
jQuery('#box .c4').removeClass('pigeon-separ-clip4 pigeon-polir-clip4 pigeon-trans-clip4 pigeon-defence-clip4 pigeon-hranenie-clip4'); 
jQuery('#box .c5').removeClass('pigeon-separ-clip5 pigeon-polir-clip5 pigeon-trans-clip5 pigeon-defence-clip5 pigeon-hranenie-clip5');
}
function animOut() {    
...
jQuery('#box .c5').removeClass(''+z+'-clip5'); }, 1400)
    ...
    {
jQuery('#box').removeClass('pigeon-separ').removeClass('pigeon-polir').removeClass('pigeon-trans').removeClass('pigeon-defence').removeClass('pigeon-hranenie').addClass(z);
animOut();
...
plata('#pigeon-polir');
plata('#pigeon-trans');
plata('#pigeon-defence');
plata('#pigeon-hranenie');      
