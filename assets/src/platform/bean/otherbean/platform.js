...
function killShapes() {
  jQuery('#box .c1').removeClass('other-separ-clip1 other-polir-clip1 other-trans-clip1 other-defence-clip1 other-hranenie-clip1'); 
jQuery('#box .c2').removeClass('other-separ-clip2 other-polir-clip2 other-trans-clip2 other-defence-clip2 other-hranenie-clip2'); 
jQuery('#box .c3').removeClass('other-separ-clip3 other-polir-clip3 other-trans-clip3 other-defence-clip3 other-hranenie-clip3'); 
jQuery('#box .c4').removeClass('other-separ-clip4 other-polir-clip4 other-trans-clip4 other-defence-clip4 other-hranenie-clip4'); 
jQuery('#box .c5').removeClass('other-separ-clip5 other-polir-clip5 other-trans-clip5 other-defence-clip5 other-hranenie-clip5');
}
function animOut() {    
...
jQuery('#box .c5').removeClass(''+z+'-clip5'); }, 1400)
    ...
    {
jQuery('#box').removeClass('other-separ').removeClass('other-polir').removeClass('other-trans').removeClass('other-defence').removeClass('other-hranenie').addClass(z);
animOut();
