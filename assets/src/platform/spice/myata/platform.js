...
function killShapes() {
  jQuery('#box .c1').removeClass('myata-separ-clip1 myata-polir-clip1 myata-trans-clip1 myata-defence-clip1 myata-hranenie-clip1'); 
jQuery('#box .c2').removeClass('myata-separ-clip2 myata-polir-clip2 myata-trans-clip2 myata-defence-clip2 myata-hranenie-clip2'); 
jQuery('#box .c3').removeClass('myata-separ-clip3 myata-polir-clip3 myata-trans-clip3 myata-defence-clip3 myata-hranenie-clip3'); 
jQuery('#box .c4').removeClass('myata-separ-clip4 myata-polir-clip4 myata-trans-clip4 myata-defence-clip4 myata-hranenie-clip4'); 
jQuery('#box .c5').removeClass('myata-separ-clip5 myata-polir-clip5 myata-trans-clip5 myata-defence-clip5 myata-hranenie-clip5');
}
function animOut() {    
...
jQuery('#box .c5').removeClass(''+z+'-clip5'); }, 1400)
    ...
    {
jQuery('#box').removeClass('myata-separ').removeClass('myata-polir').removeClass('myata-trans').removeClass('myata-defence').removeClass('myata-hranenie').addClass(z);
animOut();
