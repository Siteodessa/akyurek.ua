...
function killShapes() {
  jQuery('#box .c1').removeClass('imbir-separ-clip1 imbir-polir-clip1 imbir-trans-clip1 imbir-defence-clip1 imbir-hranenie-clip1'); 
jQuery('#box .c2').removeClass('imbir-separ-clip2 imbir-polir-clip2 imbir-trans-clip2 imbir-defence-clip2 imbir-hranenie-clip2'); 
jQuery('#box .c3').removeClass('imbir-separ-clip3 imbir-polir-clip3 imbir-trans-clip3 imbir-defence-clip3 imbir-hranenie-clip3'); 
jQuery('#box .c4').removeClass('imbir-separ-clip4 imbir-polir-clip4 imbir-trans-clip4 imbir-defence-clip4 imbir-hranenie-clip4'); 
jQuery('#box .c5').removeClass('imbir-separ-clip5 imbir-polir-clip5 imbir-trans-clip5 imbir-defence-clip5 imbir-hranenie-clip5');
}
function animOut() {    
...
jQuery('#box .c5').removeClass(''+z+'-clip5'); }, 1400)
    ...
    {
jQuery('#box').removeClass('imbir-separ').removeClass('imbir-polir').removeClass('imbir-trans').removeClass('imbir-defence').removeClass('imbir-hranenie').addClass(z);
animOut();
