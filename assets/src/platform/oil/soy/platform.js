...
function killShapes() {
  jQuery('#box .c1').removeClass('soy-separ-clip1 soy-polir-clip1 soy-trans-clip1 soy-defence-clip1 soy-hranenie-clip1'); 
jQuery('#box .c2').removeClass('soy-separ-clip2 soy-polir-clip2 soy-trans-clip2 soy-defence-clip2 soy-hranenie-clip2'); 
jQuery('#box .c3').removeClass('soy-separ-clip3 soy-polir-clip3 soy-trans-clip3 soy-defence-clip3 soy-hranenie-clip3'); 
jQuery('#box .c4').removeClass('soy-separ-clip4 soy-polir-clip4 soy-trans-clip4 soy-defence-clip4 soy-hranenie-clip4'); 
jQuery('#box .c5').removeClass('soy-separ-clip5 soy-polir-clip5 soy-trans-clip5 soy-defence-clip5 soy-hranenie-clip5');
}
function animOut() {    
...
jQuery('#box .c5').removeClass(''+z+'-clip5'); }, 1400)
    ...
    {
jQuery('#box').removeClass('soy-separ').removeClass('soy-polir').removeClass('soy-trans').removeClass('soy-defence').removeClass('soy-hranenie').addClass(z);
animOut();
