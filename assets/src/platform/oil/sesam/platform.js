...
function killShapes() {
  jQuery('#box .c1').removeClass('sesam-separ-clip1 sesam-polir-clip1 sesam-trans-clip1 sesam-defence-clip1 sesam-hranenie-clip1'); 
jQuery('#box .c2').removeClass('sesam-separ-clip2 sesam-polir-clip2 sesam-trans-clip2 sesam-defence-clip2 sesam-hranenie-clip2'); 
jQuery('#box .c3').removeClass('sesam-separ-clip3 sesam-polir-clip3 sesam-trans-clip3 sesam-defence-clip3 sesam-hranenie-clip3'); 
jQuery('#box .c4').removeClass('sesam-separ-clip4 sesam-polir-clip4 sesam-trans-clip4 sesam-defence-clip4 sesam-hranenie-clip4'); 
jQuery('#box .c5').removeClass('sesam-separ-clip5 sesam-polir-clip5 sesam-trans-clip5 sesam-defence-clip5 sesam-hranenie-clip5');
}
function animOut() {    
...
jQuery('#box .c5').removeClass(''+z+'-clip5'); }, 1400)
    ...
    {
jQuery('#box').removeClass('sesam-separ').removeClass('sesam-polir').removeClass('sesam-trans').removeClass('sesam-defence').removeClass('sesam-hranenie').addClass(z);
animOut();
