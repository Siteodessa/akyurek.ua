...
function killShapes() {
  jQuery('#box .c1').removeClass('raps-separ-clip1 raps-polir-clip1 raps-trans-clip1 raps-defence-clip1 raps-hranenie-clip1'); 
jQuery('#box .c2').removeClass('raps-separ-clip2 raps-polir-clip2 raps-trans-clip2 raps-defence-clip2 raps-hranenie-clip2'); 
jQuery('#box .c3').removeClass('raps-separ-clip3 raps-polir-clip3 raps-trans-clip3 raps-defence-clip3 raps-hranenie-clip3'); 
jQuery('#box .c4').removeClass('raps-separ-clip4 raps-polir-clip4 raps-trans-clip4 raps-defence-clip4 raps-hranenie-clip4'); 
jQuery('#box .c5').removeClass('raps-separ-clip5 raps-polir-clip5 raps-trans-clip5 raps-defence-clip5 raps-hranenie-clip5');
}
function animOut() {    
...
jQuery('#box .c5').removeClass(''+z+'-clip5'); }, 1400)
    ...
    {
jQuery('#box').removeClass('raps-separ').removeClass('raps-polir').removeClass('raps-trans').removeClass('raps-defence').removeClass('raps-hranenie').addClass(z);
animOut();
