...
function killShapes() {
  jQuery('#box .c1').removeClass('grape-separ-clip1 grape-polir-clip1 grape-trans-clip1 grape-defence-clip1 grape-hranenie-clip1'); 
jQuery('#box .c2').removeClass('grape-separ-clip2 grape-polir-clip2 grape-trans-clip2 grape-defence-clip2 grape-hranenie-clip2'); 
jQuery('#box .c3').removeClass('grape-separ-clip3 grape-polir-clip3 grape-trans-clip3 grape-defence-clip3 grape-hranenie-clip3'); 
jQuery('#box .c4').removeClass('grape-separ-clip4 grape-polir-clip4 grape-trans-clip4 grape-defence-clip4 grape-hranenie-clip4'); 
jQuery('#box .c5').removeClass('grape-separ-clip5 grape-polir-clip5 grape-trans-clip5 grape-defence-clip5 grape-hranenie-clip5');
}
function animOut() {    
...
jQuery('#box .c5').removeClass(''+z+'-clip5'); }, 1400)
    ...
    {
jQuery('#box').removeClass('grape-separ').removeClass('grape-polir').removeClass('grape-trans').removeClass('grape-defence').removeClass('grape-hranenie').addClass(z);
animOut();
