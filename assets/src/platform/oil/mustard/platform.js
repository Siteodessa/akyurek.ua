...
function killShapes() {
  jQuery('#box .c1').removeClass('mustard-separ-clip1 mustard-polir-clip1 mustard-trans-clip1 mustard-defence-clip1 mustard-hranenie-clip1'); 
jQuery('#box .c2').removeClass('mustard-separ-clip2 mustard-polir-clip2 mustard-trans-clip2 mustard-defence-clip2 mustard-hranenie-clip2'); 
jQuery('#box .c3').removeClass('mustard-separ-clip3 mustard-polir-clip3 mustard-trans-clip3 mustard-defence-clip3 mustard-hranenie-clip3'); 
jQuery('#box .c4').removeClass('mustard-separ-clip4 mustard-polir-clip4 mustard-trans-clip4 mustard-defence-clip4 mustard-hranenie-clip4'); 
jQuery('#box .c5').removeClass('mustard-separ-clip5 mustard-polir-clip5 mustard-trans-clip5 mustard-defence-clip5 mustard-hranenie-clip5');
}
function animOut() {    
...
jQuery('#box .c5').removeClass(''+z+'-clip5'); }, 1400)
    ...
    {
jQuery('#box').removeClass('mustard-separ').removeClass('mustard-polir').removeClass('mustard-trans').removeClass('mustard-defence').removeClass('mustard-hranenie').addClass(z);
animOut();
...
plata('#mustard-polir');
plata('#mustard-trans');
plata('#mustard-defence');
plata('#mustard-hranenie');      
