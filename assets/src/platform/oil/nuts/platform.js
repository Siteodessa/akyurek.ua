...
function killShapes() {
  jQuery('#box .c1').removeClass('nuts-separ-clip1 nuts-polir-clip1 nuts-trans-clip1 nuts-defence-clip1 nuts-hranenie-clip1'); 
jQuery('#box .c2').removeClass('nuts-separ-clip2 nuts-polir-clip2 nuts-trans-clip2 nuts-defence-clip2 nuts-hranenie-clip2'); 
jQuery('#box .c3').removeClass('nuts-separ-clip3 nuts-polir-clip3 nuts-trans-clip3 nuts-defence-clip3 nuts-hranenie-clip3'); 
jQuery('#box .c4').removeClass('nuts-separ-clip4 nuts-polir-clip4 nuts-trans-clip4 nuts-defence-clip4 nuts-hranenie-clip4'); 
jQuery('#box .c5').removeClass('nuts-separ-clip5 nuts-polir-clip5 nuts-trans-clip5 nuts-defence-clip5 nuts-hranenie-clip5');
}
function animOut() {    
...
jQuery('#box .c5').removeClass(''+z+'-clip5'); }, 1400)
    ...
    {
jQuery('#box').removeClass('nuts-separ').removeClass('nuts-polir').removeClass('nuts-trans').removeClass('nuts-defence').removeClass('nuts-hranenie').addClass(z);
animOut();
