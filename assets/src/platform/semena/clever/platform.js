...
function killShapes() {
  jQuery('#box .c1').removeClass('clever-separ-clip1 clever-polir-clip1 clever-trans-clip1 clever-defence-clip1 clever-hranenie-clip1'); 
jQuery('#box .c2').removeClass('clever-separ-clip2 clever-polir-clip2 clever-trans-clip2 clever-defence-clip2 clever-hranenie-clip2'); 
jQuery('#box .c3').removeClass('clever-separ-clip3 clever-polir-clip3 clever-trans-clip3 clever-defence-clip3 clever-hranenie-clip3'); 
jQuery('#box .c4').removeClass('clever-separ-clip4 clever-polir-clip4 clever-trans-clip4 clever-defence-clip4 clever-hranenie-clip4'); 
jQuery('#box .c5').removeClass('clever-separ-clip5 clever-polir-clip5 clever-trans-clip5 clever-defence-clip5 clever-hranenie-clip5');
}
function animOut() {    
...
jQuery('#box .c5').removeClass(''+z+'-clip5'); }, 1400)
    ...
    {
jQuery('#box').removeClass('clever-separ').removeClass('clever-polir').removeClass('clever-trans').removeClass('clever-defence').removeClass('clever-hranenie').addClass(z);
animOut();
...
plata('#clever-polir');
plata('#clever-trans');
plata('#clever-defence');
plata('#clever-hranenie');      
