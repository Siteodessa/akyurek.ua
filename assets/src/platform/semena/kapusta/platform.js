...
function killShapes() {
  jQuery('#box .c1').removeClass('kapusta-separ-clip1 kapusta-polir-clip1 kapusta-trans-clip1 kapusta-defence-clip1 kapusta-hranenie-clip1'); 
jQuery('#box .c2').removeClass('kapusta-separ-clip2 kapusta-polir-clip2 kapusta-trans-clip2 kapusta-defence-clip2 kapusta-hranenie-clip2'); 
jQuery('#box .c3').removeClass('kapusta-separ-clip3 kapusta-polir-clip3 kapusta-trans-clip3 kapusta-defence-clip3 kapusta-hranenie-clip3'); 
jQuery('#box .c4').removeClass('kapusta-separ-clip4 kapusta-polir-clip4 kapusta-trans-clip4 kapusta-defence-clip4 kapusta-hranenie-clip4'); 
jQuery('#box .c5').removeClass('kapusta-separ-clip5 kapusta-polir-clip5 kapusta-trans-clip5 kapusta-defence-clip5 kapusta-hranenie-clip5');
}
function animOut() {    
...
jQuery('#box .c5').removeClass(''+z+'-clip5'); }, 1400)
    ...
    {
jQuery('#box').removeClass('kapusta-separ').removeClass('kapusta-polir').removeClass('kapusta-trans').removeClass('kapusta-defence').removeClass('kapusta-hranenie').addClass(z);
animOut();
...
plata('#kapusta-polir');
plata('#kapusta-trans');
plata('#kapusta-defence');
plata('#kapusta-hranenie');      
