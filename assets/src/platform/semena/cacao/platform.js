...
function killShapes() {
  jQuery('#box .c1').removeClass('cacao-separ-clip1 cacao-polir-clip1 cacao-trans-clip1 cacao-defence-clip1 cacao-hranenie-clip1'); 
jQuery('#box .c2').removeClass('cacao-separ-clip2 cacao-polir-clip2 cacao-trans-clip2 cacao-defence-clip2 cacao-hranenie-clip2'); 
jQuery('#box .c3').removeClass('cacao-separ-clip3 cacao-polir-clip3 cacao-trans-clip3 cacao-defence-clip3 cacao-hranenie-clip3'); 
jQuery('#box .c4').removeClass('cacao-separ-clip4 cacao-polir-clip4 cacao-trans-clip4 cacao-defence-clip4 cacao-hranenie-clip4'); 
jQuery('#box .c5').removeClass('cacao-separ-clip5 cacao-polir-clip5 cacao-trans-clip5 cacao-defence-clip5 cacao-hranenie-clip5');
}
function animOut() {    
...
jQuery('#box .c5').removeClass(''+z+'-clip5'); }, 1400)
    ...
    {
jQuery('#box').removeClass('cacao-separ').removeClass('cacao-polir').removeClass('cacao-trans').removeClass('cacao-defence').removeClass('cacao-hranenie').addClass(z);
animOut();
