...
function killShapes() {
  jQuery('#box .c1').removeClass('mak-separ-clip1 mak-polir-clip1 mak-trans-clip1 mak-defence-clip1 mak-hranenie-clip1'); 
jQuery('#box .c2').removeClass('mak-separ-clip2 mak-polir-clip2 mak-trans-clip2 mak-defence-clip2 mak-hranenie-clip2'); 
jQuery('#box .c3').removeClass('mak-separ-clip3 mak-polir-clip3 mak-trans-clip3 mak-defence-clip3 mak-hranenie-clip3'); 
jQuery('#box .c4').removeClass('mak-separ-clip4 mak-polir-clip4 mak-trans-clip4 mak-defence-clip4 mak-hranenie-clip4'); 
jQuery('#box .c5').removeClass('mak-separ-clip5 mak-polir-clip5 mak-trans-clip5 mak-defence-clip5 mak-hranenie-clip5');
}
function animOut() {    
...
jQuery('#box .c5').removeClass(''+z+'-clip5'); }, 1400)
    ...
    {
jQuery('#box').removeClass('mak-separ').removeClass('mak-polir').removeClass('mak-trans').removeClass('mak-defence').removeClass('mak-hranenie').addClass(z);
animOut();
