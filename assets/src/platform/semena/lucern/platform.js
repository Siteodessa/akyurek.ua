...
function killShapes() {
  jQuery('#box .c1').removeClass('lucern-separ-clip1 lucern-polir-clip1 lucern-trans-clip1 lucern-defence-clip1 lucern-hranenie-clip1'); 
jQuery('#box .c2').removeClass('lucern-separ-clip2 lucern-polir-clip2 lucern-trans-clip2 lucern-defence-clip2 lucern-hranenie-clip2'); 
jQuery('#box .c3').removeClass('lucern-separ-clip3 lucern-polir-clip3 lucern-trans-clip3 lucern-defence-clip3 lucern-hranenie-clip3'); 
jQuery('#box .c4').removeClass('lucern-separ-clip4 lucern-polir-clip4 lucern-trans-clip4 lucern-defence-clip4 lucern-hranenie-clip4'); 
jQuery('#box .c5').removeClass('lucern-separ-clip5 lucern-polir-clip5 lucern-trans-clip5 lucern-defence-clip5 lucern-hranenie-clip5');
}
function animOut() {    
...
jQuery('#box .c5').removeClass(''+z+'-clip5'); }, 1400)
    ...
    {
jQuery('#box').removeClass('lucern-separ').removeClass('lucern-polir').removeClass('lucern-trans').removeClass('lucern-defence').removeClass('lucern-hranenie').addClass(z);
animOut();
...
plata('#lucern-polir');
plata('#lucern-trans');
plata('#lucern-defence');
plata('#lucern-hranenie');      
