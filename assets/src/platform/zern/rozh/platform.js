...
function killShapes() {
  jQuery('#box .c1').removeClass('rozh-separ-clip1 rozh-polir-clip1 rozh-trans-clip1 rozh-defence-clip1 rozh-hranenie-clip1'); 
jQuery('#box .c2').removeClass('rozh-separ-clip2 rozh-polir-clip2 rozh-trans-clip2 rozh-defence-clip2 rozh-hranenie-clip2'); 
jQuery('#box .c3').removeClass('rozh-separ-clip3 rozh-polir-clip3 rozh-trans-clip3 rozh-defence-clip3 rozh-hranenie-clip3'); 
jQuery('#box .c4').removeClass('rozh-separ-clip4 rozh-polir-clip4 rozh-trans-clip4 rozh-defence-clip4 rozh-hranenie-clip4'); 
jQuery('#box .c5').removeClass('rozh-separ-clip5 rozh-polir-clip5 rozh-trans-clip5 rozh-defence-clip5 rozh-hranenie-clip5');
}
function animOut() {    
...
jQuery('#box .c5').removeClass(''+z+'-clip5'); }, 1400)
    ...
    {
jQuery('#box').removeClass('rozh-separ').removeClass('rozh-polir').removeClass('rozh-trans').removeClass('rozh-defence').removeClass('rozh-hranenie').addClass(z);
animOut();
