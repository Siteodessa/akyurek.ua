...
function killShapes() {
  jQuery('#box .c1').removeClass('tritikale-separ-clip1 tritikale-polir-clip1 tritikale-trans-clip1 tritikale-defence-clip1 tritikale-hranenie-clip1'); 
jQuery('#box .c2').removeClass('tritikale-separ-clip2 tritikale-polir-clip2 tritikale-trans-clip2 tritikale-defence-clip2 tritikale-hranenie-clip2'); 
jQuery('#box .c3').removeClass('tritikale-separ-clip3 tritikale-polir-clip3 tritikale-trans-clip3 tritikale-defence-clip3 tritikale-hranenie-clip3'); 
jQuery('#box .c4').removeClass('tritikale-separ-clip4 tritikale-polir-clip4 tritikale-trans-clip4 tritikale-defence-clip4 tritikale-hranenie-clip4'); 
jQuery('#box .c5').removeClass('tritikale-separ-clip5 tritikale-polir-clip5 tritikale-trans-clip5 tritikale-defence-clip5 tritikale-hranenie-clip5');
}
function animOut() {    
...
jQuery('#box .c5').removeClass(''+z+'-clip5'); }, 1400)
    ...
    {
jQuery('#box').removeClass('tritikale-separ').removeClass('tritikale-polir').removeClass('tritikale-trans').removeClass('tritikale-defence').removeClass('tritikale-hranenie').addClass(z);
animOut();
...
plata('#tritikale-separ');
plata('#tritikale-polir');
plata('#tritikale-trans');
plata('#tritikale-defence');
plata('#tritikale-hranenie');      
