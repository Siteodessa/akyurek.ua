...
function killShapes() {
  jQuery('#box .c1').removeClass('ris-separ-clip1 ris-polir-clip1 ris-trans-clip1 ris-defence-clip1 ris-hranenie-clip1'); 
jQuery('#box .c2').removeClass('ris-separ-clip2 ris-polir-clip2 ris-trans-clip2 ris-defence-clip2 ris-hranenie-clip2'); 
jQuery('#box .c3').removeClass('ris-separ-clip3 ris-polir-clip3 ris-trans-clip3 ris-defence-clip3 ris-hranenie-clip3'); 
jQuery('#box .c4').removeClass('ris-separ-clip4 ris-polir-clip4 ris-trans-clip4 ris-defence-clip4 ris-hranenie-clip4'); 
jQuery('#box .c5').removeClass('ris-separ-clip5 ris-polir-clip5 ris-trans-clip5 ris-defence-clip5 ris-hranenie-clip5');
}
function animOut() {    
...
jQuery('#box .c5').removeClass(''+z+'-clip5'); }, 1400)
    ...
    {
jQuery('#box').removeClass('ris-separ').removeClass('ris-polir').removeClass('ris-trans').removeClass('ris-defence').removeClass('ris-hranenie').addClass(z);
animOut();
