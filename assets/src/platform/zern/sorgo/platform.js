...
function killShapes() {
  jQuery('#box .c1').removeClass('sorgo-separ-clip1 sorgo-polir-clip1 sorgo-trans-clip1 sorgo-defence-clip1 sorgo-hranenie-clip1'); 
jQuery('#box .c2').removeClass('sorgo-separ-clip2 sorgo-polir-clip2 sorgo-trans-clip2 sorgo-defence-clip2 sorgo-hranenie-clip2'); 
jQuery('#box .c3').removeClass('sorgo-separ-clip3 sorgo-polir-clip3 sorgo-trans-clip3 sorgo-defence-clip3 sorgo-hranenie-clip3'); 
jQuery('#box .c4').removeClass('sorgo-separ-clip4 sorgo-polir-clip4 sorgo-trans-clip4 sorgo-defence-clip4 sorgo-hranenie-clip4'); 
jQuery('#box .c5').removeClass('sorgo-separ-clip5 sorgo-polir-clip5 sorgo-trans-clip5 sorgo-defence-clip5 sorgo-hranenie-clip5');
}
function animOut() {    
...
jQuery('#box .c5').removeClass(''+z+'-clip5'); }, 1400)
    ...
    {
jQuery('#box').removeClass('sorgo-separ').removeClass('sorgo-polir').removeClass('sorgo-trans').removeClass('sorgo-defence').removeClass('sorgo-hranenie').addClass(z);
animOut();
