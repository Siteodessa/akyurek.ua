...
function killShapes() {
  jQuery('#box .c1').removeClass('lion-separ-clip1 lion-polir-clip1 lion-trans-clip1 lion-defence-clip1 lion-hranenie-clip1'); 
jQuery('#box .c2').removeClass('lion-separ-clip2 lion-polir-clip2 lion-trans-clip2 lion-defence-clip2 lion-hranenie-clip2'); 
jQuery('#box .c3').removeClass('lion-separ-clip3 lion-polir-clip3 lion-trans-clip3 lion-defence-clip3 lion-hranenie-clip3'); 
jQuery('#box .c4').removeClass('lion-separ-clip4 lion-polir-clip4 lion-trans-clip4 lion-defence-clip4 lion-hranenie-clip4'); 
jQuery('#box .c5').removeClass('lion-separ-clip5 lion-polir-clip5 lion-trans-clip5 lion-defence-clip5 lion-hranenie-clip5');
}
function animOut() {    
...
jQuery('#box .c5').removeClass(''+z+'-clip5'); }, 1400)
    ...
    {
jQuery('#box').removeClass('lion-separ').removeClass('lion-polir').removeClass('lion-trans').removeClass('lion-defence').removeClass('lion-hranenie').addClass(z);
animOut();
