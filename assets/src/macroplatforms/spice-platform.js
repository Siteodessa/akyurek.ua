...
function killShapes() {
  jQuery('#box .c1').removeClass('tmin-separ-clip1 tmin-polir-clip1 tmin-trans-clip1 tmin-defence-clip1 tmin-hranenie-clip1'); 
jQuery('#box .c2').removeClass('tmin-separ-clip2 tmin-polir-clip2 tmin-trans-clip2 tmin-defence-clip2 tmin-hranenie-clip2'); 
jQuery('#box .c3').removeClass('tmin-separ-clip3 tmin-polir-clip3 tmin-trans-clip3 tmin-defence-clip3 tmin-hranenie-clip3'); 
jQuery('#box .c4').removeClass('tmin-separ-clip4 tmin-polir-clip4 tmin-trans-clip4 tmin-defence-clip4 tmin-hranenie-clip4'); 
jQuery('#box .c5').removeClass('tmin-separ-clip5 tmin-polir-clip5 tmin-trans-clip5 tmin-defence-clip5 tmin-hranenie-clip5');
}
function animOut() {    
...
jQuery('#box .c5').removeClass(''+z+'-clip5'); }, 1400)
    ...
    {
jQuery('#box').removeClass('tmin-separ').removeClass('tmin-polir').removeClass('tmin-trans').removeClass('tmin-defence').removeClass('tmin-hranenie').addClass(z);
animOut();
