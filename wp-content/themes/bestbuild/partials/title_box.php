...
if ( get_post_meta( $post_id, 'title', true ) != 'hide' ) {
    ...
    <?php edit_post_link('Изменить страницу', '<p class="rel">', '</p>'); ?>
      <div id="melnica" class="paspin"> <div class="spinner"><img id="coga" class="" src="http://akyurek.ua/wp-content/uploads/2017/04/koleso.png"></div></div>
                    ...
                    if( $breadcrumbs != 'hide' ){
                        if( $is_shop || $is_product ){
	                        woocommerce_breadcrumb( array(
		                        ...
		                        'before'      => '',
		                        'after'       => '',
		                        'home'        => _x( 'На главную', 'breadcrumb', 'woocommerce' )
	                        ) );
                        }else{
