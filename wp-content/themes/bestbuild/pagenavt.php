...
if ( $all_projects ) {
	...
	if ( $category_filter == 'show' && $category == 'all' ) {
		...
		$output .= '<a href="#projects_carousel_all" class="active">' . __( 'Все проекты', 'bestbuild' ) . '</a>';
		if ( $categories ) {
	...
	foreach ( $all_projects as $project ) {
		$output .= '<div class="project">
           <div style="background:red">' . the_post() . '666</div>
           <div style="background:red">' . get_the_excerpt('3230') . '666</div>
           <div style="background:red">' . the_post() . '666</div>
                                        <div class="project_wr">
                                            ...
                                            <a href="' . get_the_permalink( $project->ID ) . '" class="button view_more">' . __( 'смотреть', 'bestbuild' ) . '</a>
                                        </div>
                                    </div>';
	}
	$output .= '</div>';
				...
				foreach ( $projects as $val ) {
					$projects_array[ $cat ][] = '<div class="project">
                                                            <div class="project_wr">
                                                                ...
                                                                <a href="' . get_the_permalink( $val->ID ) . '" class="button view_more">' . __( 'смотреть', 'bestbuild' ) . '</a>
                                                            </div>
                                                            </div>';
				}
			}
